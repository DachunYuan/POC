...
--py-files $GIT_HOME/lib/ITR2/kafka2spark.py,$GIT_HOME/conf/ITR2/ITR2_config.ini,$GIT_HOME/src/ITR2/redis/redis_hash.py,/home/jizho/NewTechPOC/src/ITR2/generateSql/generateSql.py,/home/jizho/NewTechPOC/src/ITR2/generateSql/RLT_ESCLT_CPCTY_ISSUE_TYPE_D.conf \
--jars $SPARK_HOME/lib/spark-streaming-kafka-assembly_2.11-1.6.3.jar \
/home/jizho/NewTechPOC/src/ITR2/kafka_spark_RLT_ESCLT_CPCTY_ISSUE_TYPE_D.py
