...
def process_data(iterator):
    sql_insert = generateInsertSQL("ITR23.RLT_ESCLT_DVC_D","./RLT_ESCLT_DVC_D.conf")
        ...
        for i in range(len(oneArray)):
            ...
            if rs[0]:
                ...
                if r_s[1] != md5_str:
                    ...
                    update_sql = generateUpdateSql("ITR23.RLT_ESCLT_DVC_D","RLT_ESCLT_DVC_D.conf",["ESCLT_DVC_D_KY",r_s[0]])
