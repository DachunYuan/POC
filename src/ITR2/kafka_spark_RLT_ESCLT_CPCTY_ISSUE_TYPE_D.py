...
def process_data(iterator):
    sql_insert = generateInsertSQL("ITR23.RLT_ESCLT_CPCTY_ISSUE_TYPE_D","./RLT_ESCLT_CPCTY_ISSUE_TYPE_D.conf")
        ...
        for i in range(len(oneArray)):
            ...
            if rs[0]:
                ...
                if r_s[1] != md5_str:
                    ...
                    update_sql = generateUpdateSql("ITR23.RLT_ESCLT_CPCTY_ISSUE_TYPE_D","RLT_ESCLT_CPCTY_ISSUE_TYPE_D.conf",["ESCLT_CPCTY_ISSUE_TYPE_D_KY",r_s[0]])
                ...
                if res[0]:
                    ...
                    con.commit()
                    RedisOp(["set","ESCLT_CPCTY_ISSUE_TYPE_D_KY_count",count])
                else:
                    r_s.append(1)
                    #inster data to the database
...
if __name__ == "__main__":
    ...
    topics = "RLT_ESCLT_CPCTY_ISSUE_TYPE_D"
